...
if (get_the_ID() == "null") {
	...
	if (!$post) {
		...
		if ($remotely == "on") {
			...
			$remo = '<center><p class="smBox">' . forceTranslate("The job can be performed remotely", "يمكن أداء الوظيفة عن بُعد") . '</p></center>';
						...
						<div class="boxed<?php print $boxed; ?> addPaddAll-40">
							...
							<?php if ($postType != "jobseekers") { ?>
								...
								<h4 class="fnt-bold <?php print $fontLang; ?>">
									...
									<?php print forceTranslate("Job description", "المسمى الوظيفي"); ?>
							...
							<div class="row remPad content-14">
									...
									<div class="row content-eap">
										...
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-4">
													<p class="fnt<?php print $subColor; ?>"><?php print forceTranslate("Role", "الدور"); ?>:</p>
												</div>
										...
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-4">
													<p class="fnt<?php print $subColor; ?>"><?php print forceTranslate("Industry Type", "تصنيف الوظيفة"); ?>:</p>
												</div>
										...
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-4">
													<p class="fnt<?php print $subColor; ?>"><?php print forceTranslate("Degree", "الدرجة العلمية"); ?>:</p>
												</div>
										...
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-4">
													<p class="fnt<?php print $subColor; ?>"><?php print forceTranslate("English proficiency", "مستوى إجادة اللغة الإنجليزية"); ?>:</p>
												</div>
										...
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-4">
													<p class="fnt<?php print $subColor; ?>"><?php print forceTranslate("Essential skills:", ":مهارات أساسية"); ?>:</p>
												</div>
										...
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-4">
													<p class="fnt<?php print $subColor; ?>"><?php print forceTranslate("Job classification", "تصنيف الوظيفة"); ?>:</p>
												</div>
										...
										<div class="col-md-12">
											...
											<div class="row">
												...
												<div class="col-md-2">
													<p class="fnt<?php print $subColor; ?>"><?php print forceTranslate("Attachments", "مرفقات"); ?>:</p>
												</div>
											...
											<div class="row">
												...
												<div class="col-4">
													<p class="fnt<?php print $subColor; ?>">
														...
														<?php print forceTranslate("Service Description", "وصف الخدمة"); ?>:
											...
											<div class="row">
												...
												<div class="col-4">
													<p class="fnt<?php print $subColor; ?>">
														...
														<?php print forceTranslate("Service Classification", "تصنيف الخدمة"); ?>:</p>
											...
											<div class="row">
												...
												<div class="col-4">
													...
													<p class="fnt<?php print $subColor; ?>">
														...
														<?php print forceTranslate("Education Level", "مستوى التعليم"); ?>:
											...
											<div class="row">
												...
												<div class="col-4">
													...
													<p class="fnt<?php print $subColor; ?>">
														...
														<?php print forceTranslate("Essential skills", "مهارات أساسية"); ?>:
								...
								<p class="fnt-15 fnt-bold">
									...
									<?php } else { ?>
										...
										<?php print forceTranslate("Openings", "فرص العمل "); ?>: <?php print $vacancy; ?> |

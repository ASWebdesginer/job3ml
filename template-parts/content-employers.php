									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<p>
												...
												<?php print forceTranslate("year(s) experience","سنوات من الخبرة");?>
									...
									<div class="row content-eap">
										...
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-4"><p class="fnt<?php print $subColor;?>"><?php print forceTranslate("Employment Sector","تصنيف الوظيفة");?>:</p></div>
											...
											<div class="row">
												...
												<div class="col-4">
													...
													<p class="fnt<?php print $subColor;?>">
														...
														<?php print forceTranslate("Education Level","الدرجة العلمية");?>:
											...
											<div class="row">
												...
												<div class="col-4">
													...
													<p class="fnt<?php print $subColor;?>">
														...
														<?php print forceTranslate("Essential skills","المهارات الاساسية");?>

<?php /* Template Name: Employer Update Ad Forms Page */ ?>
...
//		  print_r($post);
          ...
          $salaryFrom = floatval(get_field("salary_from",$postId));

          $salaryTo = floatval(get_field("salary_to",$postId));

		  $ave_salary = floatval(get_field("ave_salary",$postId));
    ...
    <section>
        ...
        <div class="container">
            ...
            <center>
                ...
                <h1 class="fnt-bl fnt-bold"><?php print forceTranslate("Employment Advertisements", "إعلانات التوظيف")?></h1>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="boxed-shadowed addPaddSide-60">
                        ...
                        <form action="" method="post" id="editJobPost" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="company" type="text" class="form-control form-gry w-100" placeholder="" required value="<?php echo $companyName;?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="country" id="country" class="form-control selectpicker remPad"  data-live-search="true" required value="<?php echo $country;?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="city" id="city" class="form-control form-gry selectpicker remPad" data-live-search="true"    required value="<?php echo $city;?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 d-flex justify-content-end">
                                            ...
                                            <div class="form-check form-switch text-end">
                                              ...
                                              <input name="hideEmail" class="form-check-input" type="checkbox" role="switch" <?php echo $checked_attribute; ?>>
                                    ...
                                    <input name="email" type="email" class="form-control form-gry w-100" value="<?php echo get_field("email",$postId);?>" placeholder="" required >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="job_name" type="text" class="form-control form-gry w-100" placeholder="placeholder="<?php print forceTranslate("Senior Accountant","محامي");?>"" value="<?php echo $jobName;?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 d-flex justify-content-end">
                                            ...
                                            <div class="form-check form-switch text-end">
                                              ...
                                              <input name="hideMobile" class="form-check-input" type="checkbox" role="switch" <?php echo $checked_attribute; ?>>
                                    ...
                                    <div id="payment">
                                        ...
                                        <div class="input-group mb-3">
                                          ...
                                          <input name="mobile" id="mobile" type="number" class="form-control bgGrayFieldPad" min="1000000" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(^0+)|(\D)/g, '');" placeholder="555" value="<?php echo get_field("mobile",$postId);?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="degree" id="degree" class="form-control form-gry selectpicker remPad" value="<?php echo $education;?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="employment" type="text" class="form-control form-gry w-100" placeholder="" value="<?php echo $employment;?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="pType" id="pType" class="form-control form-gry selectpicker remPad" required value="<?php echo $shift;?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="yrExp" type="number" value="<?php echo $experience;?>" class="form-control form-gry w-100" placeholder="" min="1" max="99" oninput="this.value = this.value.slice(0, 2);" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input id="fromSalary" name="salary_from" type="number" class="form-control form-gry w-100" placeholder="<?php print forceTranslate("From","من");?>" value="<?php echo $salaryFrom; ?>">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input id="toSalary" name="salary_to" type="number" class="form-control form-gry w-100" placeholder="<?php print forceTranslate("To","إلى");?>" min="0" value="<?php echo $salaryTo; ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="skills" type="text" class="form-control form-gry w-100" placeholder="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="vacancy" type="number" class="form-control form-gry w-100" placeholder="" value="<?php echo $vacancy; ?>" >
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    ...
                                    <div class="form-check">
                                            <?php
                                                // Check if the ACF field is true
                                                $checked_attribute = $remotely ? 'checked' : '';
                                                ?>

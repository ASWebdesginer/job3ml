<?php /* Template Name: Services Ad Forms Page */ ?>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="boxed-shadowed addPaddSide-60">
                        ...
                        <form action="" method="post" id="addNewServicePost" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="storeName" type="text" class="form-control form-gry w-100 limit-w-ten" placeholder="<?php print forceTranslate("Amperes electrical solutions","أمبير للحلول الكهربائية");?>" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="description" type="text" class="form-control form-gry w-100 limit-w-ten" placeholder="<?php print forceTranslate("Electrician","فني كهربائي");?>" required>
                            ...
                            <div class="row">
							  ...
							  <div class="col-md-6">
                                    ...
                                    <label for=""><?php print forceTranslate("Service Classification","تصنيف الخدمة");?> <font class="fnt-rd">*</font></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="yrExp" type="number" class="form-control form-gry w-100" placeholder="3" min="1" max="99" oninput="this.value = this.value.slice(0, 2);">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 d-flex justify-content-end">
                                            ...
                                            <div class="form-check">
                                              ...
                                              <input name="negotiable" class="form-check-input" type="checkbox" value="" >
                                    ...
                                    <input name="averageSalary" type="number" class="form-control form-gry w-100" placeholder="3000" min="1" max="99999" oninput="this.value = this.value.slice(0, 5);" required>
